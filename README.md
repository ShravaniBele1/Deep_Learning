...
- [Running the LangChain Project (Lab 7)](#-running-the-langchain-project-lab-7)
...
| **Lab 7** | **LLM Orchestration with LangChain** | N/A | Exploring Large Language Model (LLM) orchestration using LangChain and the Groq API. Demonstrates prompt engineering and building AI chains. | [`DL07_LangchainProject.ipynb`](./DL07_LangchainProject.ipynb) |
...
## Running the LangChain Project (Lab 7)

Lab 7 explores Large Language Models using LangChain and the Groq API.

1. Open `DL07_LangchainProject.ipynb` in Google Colab or your local Jupyter environment.
2. Ensure you have your Groq API key ready.
3. Replace the placeholder `"ApiKey"` with your actual Groq API Key in the environment variable setup cell:
   ```python
   import os
   os.environ["GROQ_API_KEY"] = "your_actual_api_key_here"
   ```
4. Run the cells to interact with the LLM via LangChain.
